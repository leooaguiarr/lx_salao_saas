...
-- ============================================================
-- 8. A ALTERAÇÃO EM finalizar_venda
-- ============================================================
--
...
--
--      SELECT oid::regprocedure, pronargs FROM pg_proc p
--      JOIN pg_namespace n ON n.oid = p.pronamespace
--      WHERE n.nspname = 'public' AND proname = 'finalizar_venda';
--
--    Esperado: uma linha, `pronargs = 1`.
--
-- 2. Os três patches entraram:
--
--      SELECT pg_get_functiondef(oid) LIKE '%gerar_crediario%'        AS tem_crediario,
--             pg_get_functiondef(oid) LIKE '%on_credit%'              AS tem_status,
--             pg_get_functiondef(oid) LIKE '%chega na Fase E%'        AS trava_saiu_nao
...
--      FROM pg_proc p JOIN pg_namespace n ON n.oid = p.pronamespace
--      WHERE n.nspname = 'public' AND proname IN ('gerar_crediario', 'receber_crediario');
--
--    Esperado:
